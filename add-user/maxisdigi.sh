...
patchtls=/hantu-vmesswstls
patchnontls=/hantu-vmesswsntls
...
patchtls=/hantu-vlesswstls
patchnontls=/hantu-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/hantu-trojanwstls
patchnone=/hantu-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
